...
class PageItem:
  ...
  thrift_spec = (
    ...
    (10, TType.MAP, 'metadataItems', (TType.STRING,None,TType.LIST,(TType.STRING,None)), None, ), # 10
  )

  def __init__(self, id=None, url=None, lru=None, crawlerTimestamp=None, httpStatusCode=None, depth=None, errorCode=None, isFullPrecision=thrift_spec[8][4], isNode=None, metadataItems=None,):
    self.id = id
    self.url = url
    self.lru = lru
  ...
  def write(self, oprot):
    ...
    if self.metadataItems is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.LIST, len(self.metadataItems))
...
class NodeLink:
  ...
  def __init__(self, id=None, sourceLRU=None, targetLRU=None, weight=thrift_spec[4][4],):
    self.id = id
...
class WebEntity:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'id', None, None, ), # 1
    (2, TType.LIST, 'LRUlist', (TType.STRING,None), None, ), # 2
    (3, TType.STRING, 'name', None, None, ), # 3
  )

  def __init__(self, id=None, LRUlist=None, name=None,):
    self.id = id
    self.LRUlist = LRUlist
    self.name = name
  ...
  def write(self, oprot):
    ...
    if self.id is not None:
      ...
      oprot.writeString(self.id)
      oprot.writeFieldEnd()
    if self.LRUlist is not None:
      oprot.writeFieldBegin('LRUlist', TType.LIST, 2)
      oprot.writeListBegin(TType.STRING, len(self.LRUlist))
      for iter22 in self.LRUlist:
...
class WebEntityCreationRule:
  ...
  def __init__(self, regExp=None, LRU=None,):
    self.regExp = regExp
    self.LRU = LRU
