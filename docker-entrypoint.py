...
if "HYPHE_WEBARCHIVES_OPTIONS"   in environ: setConfig("option", environ["HYPHE_WEBARCHIVES_OPTIONS"] or [],configdata, "webarchives")
if "HYPHE_WEBARCHIVES_DATE"      in environ: setConfig("date", environ["HYPHE_WEBARCHIVES_DATE"],configdata or "", "webarchives")
if "HYPHE_WEBARCHIVES_DAYSRANGE" in environ: setConfig("days_range", environ["HYPHE_WEBARCHIVES_OPTIONS"] or 0,configdata, "webarchives")
