...
ARCHIVES_OPTIONS = {
    ...
    "dlweb.ina.fr": {
        ...
        "permalinks_prefix": "https://dlweb.ina.fr/version.dlweb/DATE:TIME/SOURCEURL",
...
RE_BNF_ARCHIVES_PERMALINK = re.compile(r'<input[\s\r\n]+id="permalink"[\s\r\n]+class="BANNER_PERMALIEN_LINK_CUSTOMED"[\s\r\n]+value="([^"]+)"', re.DOTALL)
