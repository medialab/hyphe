...
if __name__== "__main__":
    ...
    def process(res):
        ...
        for url, tld in [
            ...
            ("help.www.福岡.jp", "福岡.jp"),              # utf8 case
            ("syria.arabic.variant.سوريا", "سوريا"),      # utf8 case 2
            ("192.169.1.1", ""),                           # no tld case
            ("localhost:8080", ""),                        # no tld case 2
            ("localhost", ""),                             # no tld case 3
          ]:
            try:
...
("s:https|h:jp|h:福岡|h:www|h:help|p:en|p:index.html|", "s:https|h:福岡.jp|h:www|h:help|p:en|p:index.html|"),        # utf8 case
