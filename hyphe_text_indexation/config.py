...
ELASTICSEARCH_TIMEOUT_SEC = int(os.environ.get('HYPHE_ELASTICSEARCH_TIMEOUT_SEC', 120))
MONGO_HOST = os.environ.get("HYPHE_MONGO_HOST","127.0.0.1")
MONGO_PORT = int(os.environ.get("HYPHE_MONGO_PORT", 27017))
NB_INDEXATION_WORKERS = int(os.environ.get("HYPHE_TXT_INDEXATION_NB_INDEXATION_WORKERS", 6))
